...
class _ContainerCuponsState extends State<ContainerCupons> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        setState(() {
          cupomSelecionado = widget.cupons.cupom.id;
        });
      },
      child: Column(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              border: Border.all(color: cupomSelecionado == widget.cupons.cupom.id ? Colors.red : Colors.transparent),
              ...
              children: [
                ...
                Center(
                  child: Column(
                    ...
                    children: [
                      Text(
                        widget.cupons.cupom.nmCupom,
                        style: TextStyle(fontWeight: FontWeight.bold),
                      ),
                      Text(
                        '${widget.cupons.cupom.valorCupom} % de desconto',
